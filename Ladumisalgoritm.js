  ...
  */
  function laienda (tase, maxTase, seis, sonastik) {
    if (seis[0][0] !== '') {
      ...
      let taiendused = taiendaSonaks(seis[0][0], sonastik, 'eest')
    ...
    if (seis[0][2] !== '') {
      // Leia täiendused sõnaks
      let taiendused = taiendaSonaks(seis[0][2], sonastik, 'tagant')
      taiendused.forEach(t => {
        // Täienda seisu, kuid sõna ei tohi kaks korda esineda
    ...
    if (seis[1][0] !== '') {
      // Leia täiendused sõnaks
      let taiendused = taiendaSonaks(seis[1][0], sonastik, 'eest')
      taiendused.forEach(t => {
        // Täienda seisu, kuid sõna ei tohi kaks korda esineda
    ...
    if (seis[1][2] !== '') {
      // Leia täiendused sõnaks
      let taiendused = taiendaSonaks(seis[1][2], sonastik, 'tagant')
      taiendused.forEach(t => {
        // Täienda seisu, kuid sõna ei tohi kaks korda esineda
